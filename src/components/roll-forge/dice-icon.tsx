...
const DF = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
      ...
      <path
        ...
        fill="url(#grad1)"
      />
      <path d="M12 7V17" stroke="hsl(var(--primary-foreground))" strokeWidth="2" strokeLinecap="round" />
      <path d="M7 12H17" stroke="hsl(var(--primary-foreground))" strokeWidth="2" strokeLinecap="round" />
      <path d="M7 7L17 17" stroke="hsl(var(--primary-foreground))" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="3 4"/>
    </svg>
  );
