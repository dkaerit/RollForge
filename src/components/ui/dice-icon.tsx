...
const DF = (props: SVGProps<SVGSVGElement>) => (
    ...
    >
      ...
      <path
        ...
        fill="url(#grad1)"
      />
      <path d="M12 5V19" stroke="hsl(var(--foreground))" strokeWidth="2" strokeLinecap="round" />
      <path d="M5 12H19" stroke="hsl(var(--foreground))" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
